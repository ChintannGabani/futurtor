        ...
        <div className="flex flex-col w-full relative min-h-screen bg-stone-50 overflow-hidden">
            ...
            <section className="relative pt-36 pb-28 px-4 sm:px-6 lg:px-8 w-full z-10 bg-[#0B1121] overflow-hidden min-h-[60vh] flex items-center">
                ...
                <div className="relative max-w-5xl mx-auto z-20 text-center w-full">
                    <div className="svc-hero-el inline-flex items-center gap-2 px-5 py-2 rounded-full bg-orange-500/10 border border-orange-500/20 mb-8 text-sm text-orange-400 font-semibold backdrop-blur-sm">
                        <Icon icon="mdi:briefcase-outline" width={16} />
                        <span>Professional Consulting</span>
                    </div>
                    <h1 className="svc-hero-el hero-heading font-black tracking-tight mb-6 text-white">Our Services</h1>
                    <p className="svc-hero-el text-lg text-stone-300 max-w-2xl mx-auto leading-relaxed">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {servicesList.map((service, idx) => (
                            <Link key={idx} to={service.link}>
                                <div className="svc-card premium-card rounded-2xl p-8 h-full group relative overflow-hidden">
            ...
            <section ref={trustRef} className="relative py-28 px-4 sm:px-6 lg:px-8 w-full bg-[#0B1121] overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center relative z-10">
                    ...
                    <div className="trust-el relative flex items-center justify-center h-[400px]">
