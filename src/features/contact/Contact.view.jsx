        ...
        <div ref={pageRef} className="flex flex-col w-full relative min-h-screen bg-stone-50 overflow-hidden">
            ...
            <section className="relative pt-28 sm:pt-36 pb-32 sm:pb-40 px-4 sm:px-6 lg:px-8 w-full z-10 bg-[#0B1121] overflow-hidden min-h-[60vh] flex items-center">
                ...
                <div className="relative max-w-5xl mx-auto z-20 text-center w-full">
                    <div className="ct-hero-el inline-flex items-center gap-2 px-5 py-2 rounded-full bg-orange-500/10 border border-orange-500/20 mb-6 text-sm text-orange-400 font-semibold backdrop-blur-sm">
                    </div>
                    <h1 className="ct-hero-el text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black tracking-tight mb-5 text-white leading-[1.08]">
                        Let's Start Your <span className="text-orange-500">Journey</span> Together
                    </h1>
                    <p className="ct-hero-el text-base sm:text-lg text-stone-300/90 max-w-2xl mx-auto leading-relaxed">
                        {data.description}
                    </p>
                </div>
            ...
            <section className="ct-form-section relative py-16 sm:py-24 px-4 sm:px-6 lg:px-8 w-full z-10 bg-stone-50 overflow-hidden">
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-5 gap-10 lg:gap-14 items-start">
                    ...
                    {/* Form - 3 cols */}
                    <div className="ct-form-wrap lg:col-span-3">
                    ...
                    {/* Side content - 2 cols */}
                    <div className="ct-side-wrap lg:col-span-2 space-y-6 lg:sticky lg:top-32">
                        {/* Quick connect */}
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="space-y-4">
                        {[
                            ...
                            <details key={idx} className="ct-faq group">
