export const NAV_LINKS = [
    ...
    },
    {
        ...
        subLinks: [
            ...
            { label: 'Finland', href: '/study-abroad/finland', icon: 'flag:fi-4x3' },
            { label: 'Switzerland', href: '/study-abroad/switzerland', icon: 'flag:ch-4x3' },
            { label: 'Ireland', href: '/study-abroad/ireland', icon: 'flag:ie-4x3' },
            // { label: 'Austria', href: '/study-abroad/austria', icon: 'flag:at-4x3', comingSoon: true },
            { label: 'France', href: '/study-abroad/france', icon: 'flag:fr-4x3' },
            // { label: 'Sweden', href: '/study-abroad/sweden', icon: 'flag:se-4x3', comingSoon: true },
            { label: 'Netherlands', href: '/study-abroad/netherlands', icon: 'flag:nl-4x3' },
